...
class EmissionsReportExporter:
    ...
    CSV_COLUMNS = [
        ...
        'opening_embodied_emissions_kgco2e',
        'envelope_embodied_emissions_kgco2e',
        'component_embodied_emissions_kgco2e',
        'opening_end_of_life_emissions_kgco2e',
        'envelope_end_of_life_emissions_kgco2e',
        'component_end_of_life_emissions_kgco2e',
